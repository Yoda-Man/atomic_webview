...
public class AtomicWebviewPlugin: NSObject, FlutterPlugin {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let instance = AtomicWebviewPlugin(methodChannel: channel)
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case "evaluateJavaScript":
      ...
      break
    case "openDevToolsWindow", "postWebMessageAsString", "postWebMessageAsJson":
      result(FlutterError(
        code: "unsupported",
        message: "\(call.method) is only supported on Windows",
        details: nil
      ))
      break
    default:
