...
class WebViewLayoutController: NSViewController {
  ...
  weak var webViewPlugin: AtomicWebviewPlugin?
  ...
  override func loadView() {
    ...
    ClientMessageChannelPlugin.register(with: titleBarController.registrar(forPlugin: "AtomicWebviewPlugin"))
...
extension WebViewLayoutController: WKNavigationDelegate {
  private func reportNavigationError(_ error: Error) {
    ...
    methodChannel.invokeMethod("onNavigationError", arguments: [
      ...
      "code": nsError.code,
      "url": nsError.userInfo[NSURLErrorFailingURLStringErrorKey] as? String,
    ] as [String: Any?])
  }
